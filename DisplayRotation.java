...
public class DisplayRotation {
    ...
    DisplayRotation(WindowManagerService service, DisplayContent displayContent,
        ...
        mContextualController = new ContextualRotationController(context); //inicializacao da rotatacao contextual
    }
    ...
    int rotationForOrientation(@ScreenOrientation int orientation,
        ...
        if (!isDefaultDisplay) {
            ...
            boolean isContextualMode = mContextualController != null && mContextualController.shouldForceRotation();
            ...
            // --- FIM DA LÓGICA (Certifique-se que não tem nenhum 'preferredRotation =' logo abaixo desta linha) ---
